package org.example.appfinanceiro.main;

import org.example.appfinanceiro.application.ProcessarTransacaoUseCase;
import org.example.appfinanceiro.domain.*;
...
public class Main {
    ...
    static void main() {
        ...
        Transacao receita2 = new Receita("SalÃ¡rio", categoria, valor2);
